/* Extraído de casamento-bianca-e-donizete.html para funcionar com o CSP (script-src 'self').
   Não voltar a colocar este código dentro do HTML. */

document.addEventListener('DOMContentLoaded', () => {
            const basePath = "../assets/img-web/portfolio/casamentos/Bianca & Donizete/";
            const folderData = [
            ...
            folderData.forEach(folder => {
                ...
                // Usa o script unificado gallery.js para carregar a pasta
